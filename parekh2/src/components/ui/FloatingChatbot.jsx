      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="bg-[#f8fafc] w-[calc(100vw-2rem)] sm:w-[380px] max-w-[380px] rounded-2xl shadow-2xl overflow-hidden mb-4 border border-gray-200"
          >
            {/* Header */}
            <div className="bg-[#C48B5D] px-5 py-4 flex items-center justify-between rounded-t-2xl">
              <div className="flex items-center space-x-3">
                <div className="w-2.5 h-2.5 bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-white font-bold tracking-wide">Sutra AI Assistant</span>
              </div>
              <button 
            ...
            {/* Chat Body */}
            <div className="p-5 h-[320px] max-h-[45vh] overflow-y-auto bg-[#f8fafc]">
              <div className="bg-white text-gray-700 p-4 rounded-2xl rounded-tl-sm shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] border border-gray-100 max-w-[85%]">
                <p className="text-[15px] leading-relaxed font-sans">
                  Namaste! 🙏 Welcome to SutraTEX. How can I help you today?
                </p>
              </div>
            </div>
