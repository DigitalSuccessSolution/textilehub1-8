...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-[100px] right-5 z-50 group floating-widget"
    >
      {/* Tooltip */}
      <span
        ...
        style={{
          background: 'linear-gradient(135deg, #E14D2A, #303030)',
          color: '#E14D2A',
          border: '1px solid rgba(225,77,42,0.3)',
      ...
      {/* Button */}
      <div
        className="w-13 h-13 w-[52px] h-[52px] rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-1"
        style={{
      ...
      >
        {/* Pulse ring */}
        <span
          className="absolute w-[52px] h-[52px] rounded-full animate-ping opacity-30"
