...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-[#25D366] text-white w-14 h-14 rounded-none shadow-xl hover:bg-[#128C7E] hover:-translate-y-1 transition-all z-50 flex items-center justify-center border border-[#128C7E]"
