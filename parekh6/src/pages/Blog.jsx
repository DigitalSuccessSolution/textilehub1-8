  ...
  return (
    <div className="pb-20 max-w-7xl mx-auto px-4">
      <div className="text-center py-16">
        <h1 className="font-playfair text-5xl text-vastram-brown">The Textile Journal</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
        {posts.map((post, idx) => (
          ...
          >
            <div className="w-full aspect-[16/10] overflow-hidden rounded-none mb-5 shadow-sm">
              <img 
                src={post.image} 
                alt={post.title}
            ...
            <h3 className="font-playfair font-bold text-xl text-[#333] mb-1.5 group-hover:text-vastram-brown transition-colors leading-snug">
              {post.title}
            </h3>
            ...
            <div className="mt-auto pt-2">
              <span className="flex items-center text-vastram-brown font-bold text-[13px] tracking-wide group-hover:text-vastram-brown transition-colors">
