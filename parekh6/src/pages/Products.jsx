  ...
  return (
    <div className="pb-16 max-w-7xl mx-auto px-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 pt-8">
        <div>
          <p className="text-vastram-gold font-bold tracking-[0.2em] uppercase text-xs mb-2">TEXTILE MALL</p>
          <h1 className="font-playfair text-5xl md:text-6xl text-vastram-brown font-bold">Catalogue</h1>
        </div>
        <div className="mt-6 md:mt-0 bg-vastram-brown text-white px-6 py-3 rounded-none flex items-center gap-3 shadow-lg">
          <ShoppingBag size={18} />
