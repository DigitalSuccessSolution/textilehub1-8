        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Founded with a passion for quality and an eye for elegance, AuraWeave Textiles has been a cornerstone of the textile retail industry for over three decades. We bring the rich heritage of Indian weaving and modern fabric technology directly to you.
              </p>
              <p>
