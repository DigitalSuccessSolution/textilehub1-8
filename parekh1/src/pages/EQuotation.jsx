      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="bg-brand-darkbrown text-white p-8 rounded-xl shadow-lg mb-8">
          <div className="flex items-center justify-between mb-6">
             <h3 className="text-2xl font-serif font-bold">Recent Quotations</h3>
        ...
        <div className="bg-white p-8 md:p-12 rounded-xl shadow-xl border border-gray-100">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-serif font-bold text-brand-darkbrown mb-4">Request a New Quotation</h2>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="submit" className="w-full bg-brand-maroon text-white font-bold py-4 px-6 rounded hover:bg-red-900 transition-colors shadow-lg">
              Generate Request
            </button>
          </form>
        </div>
