...
const TradeCircular = () => {
  const circulars = [
    { id: 1, title: 'Revised Pricing for Silk Yarns - Q4', date: 'Oct 15, 2023' },
    { id: 2, title: 'New Distributor Onboarding Guidelines', date: 'Sep 28, 2023' },
    { id: 3, title: 'Festive Season Dispatch Schedule', date: 'Sep 10, 2023' },
    { id: 4, title: 'GST Update on Handloom Products', date: 'Aug 05, 2023' },
  ];

  return (
    <div>
      <PageHeader title="Trade Circular" />
            ...
            {circulars.map((circular) => (
              <div key={circular.id} className="p-6 hover:bg-gray-50 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button className="flex items-center px-4 py-2 bg-brand-maroon text-white text-sm font-medium rounded hover:bg-red-900 transition-colors">
